...
CREATE POLICY "Update policy 1oj01fe_0" ON "storage"."objects" FOR UPDATE TO "authenticated" USING (("bucket_id" = 'avatars'::"text"));



CREATE POLICY "Update policy 1oj01fe_1" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'avatars'::"text"));
