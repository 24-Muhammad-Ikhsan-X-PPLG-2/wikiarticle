...
const DateInput: FC<Props> = ({ error, nameInput, ref, ...props }) => {
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        <CalendarFold className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 dark:text-gray-500 pointer-events-none" />
        <input
          type="date"
